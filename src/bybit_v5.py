...
class BybitV5Client:
    def __init__(
        ...
        *,
        ...
        self.network = str(network or "mainnet").lower()
    ...
    async def __aenter__(self) -> "BybitV5Client":
    ...
    def _sign_get(self, query_string: str, timestamp_ms: str) -> str:
        ...
        return generate_signature(self.api_secret, prehash, network=self.network)
    ...
    async def _get_session(self) -> aiohttp.ClientSession:
        if self._closed:
            raise RuntimeError("BybitV5Client ya fue cerrado")
